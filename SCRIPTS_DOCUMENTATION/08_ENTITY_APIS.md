...
- **Hostile Monitoring** - Track threatening entities for safety
...
if #hostiles > 0 then
   AltoClef.log("" .. #hostiles .. " hostile entities detected!")
...
for i, hostile in ipairs(hostiles) do
   ...
   if inSight then
       AltoClef.log("" .. hostile.name .. " can see you!")
   end
end
```
   ...
   for i, hostile in ipairs(hostiles) do
       if hostile.distance < 10 then
           ...
           if hostile.canSeePlayer then
               AltoClef.log("THREAT: " .. hostile.name .. " sees you! Distance: " .. hostile.distance)
           end
       end
   end
